...
workbook1=openpyxl.load_workbook(file1,data_only = True)
...
for i in range(1,row_count+1):
    ...
    iterable_fasal.append(sheet1.cell(i+1,12).value)
    ...
    do_fasli_s.append(sheet1.cell(i+1,13).value)
    do_fasli_a.append(sheet1.cell(i+1,14).value)
    uncul_area.append(sheet1.cell(i+1,15).value)
    akrishak_vivran.append(sheet1.cell(i+1,16).value)
...
print(do_fasli_a)
print(uncul_area)
print(akrishak_vivran)
print(len(iterable_gata))
print(len(do_fasli_a),len(do_fasli_s),len(uncul_area))
