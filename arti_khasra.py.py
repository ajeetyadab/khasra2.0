...
def khatauni_detail_extracion(i):
    ...
    entered_fasal=(driver.find_element(By.XPATH,"//*[@id=\"tab-3\"]/table/tbody/tr[2]/td[1]").text)
    boya_area=float(driver.find_element(By.XPATH,"//*[@id=\"tab-3\"]/table/tbody/tr[2]/td[2]").text)
    print(entered_fasal)
    print(boya_area)
    
    
    sheet1.append([f'{i}',f'{gata_num_list[1].strip()}',float(f'{gata_area}'),f'{gata_uid_list[1].strip()}',f'{khata_name_list[1].strip()}',f'{entered_fasal}',f'{boya_area}'])
